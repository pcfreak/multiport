...
wget -O /etc/xray/geoip.dat https://raw.githubusercontent.com/Tarap-Kuhing/multiport/main/xray/geoip.dat
wget -O /etc/xray/geosite.dat https://raw.githubusercontent.com/Tarap-Kuhing/multiport/main/xray/geosite.dat
