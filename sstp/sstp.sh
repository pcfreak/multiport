...
wget -O /etc/accel-ppp.conf "https://raw.githubusercontent.com/Tarap-Kuhing/multiport/main/sstp/accel-ppp.conf"
...
#input perintah sstp
wget -O /usr/bin/addsstp https://raw.githubusercontent.com/Tarap-Kuhing/multiport/main/sstp/addsstp.sh && chmod +x /usr/bin/addsstp
wget -O /usr/bin/delsstp https://raw.githubusercontent.com/Tarap-Kuhing/multiport/main/sstp/delsstp.sh && chmod +x /usr/bin/delsstp
wget -O /usr/bin/ceksstp https://raw.githubusercontent.com/Tarap-Kuhing/multiport/main/sstp/ceksstp.sh && chmod +x /usr/bin/ceksstp
wget -O /usr/bin/renewsstp https://raw.githubusercontent.com/Tarap-Kuhing/multiport/main/sstp/renewsstp.sh && chmod +x /usr/bin/renewsstp
rm -f /root/sstp.sh
